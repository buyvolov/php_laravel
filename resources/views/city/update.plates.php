            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default panel-block">
                            <form action="/city/<?=$city->id?>" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                                    ...
                                    <div class="list-group">
                                        <div class="list-group-item">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="<?=$city->name?>" class="form-control parsley-error" placeholder="Username" data-parsley-required="true">
